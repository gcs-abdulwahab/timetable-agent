            ...
            <div key={slot.id} className="bg-white border rounded-lg p-3">
              {isEditingSlot === String(slot.id) ? (
                ...
                <div className="flex justify-between items-center">
                  <div>
                    <span className="font-bold text-lg text-blue-700">Period {slot.period}</span>
                    <span className="text-gray-600 ml-2">{formatTime(slot.start)} - {formatTime(slot.end)}</span>
                  </div>
